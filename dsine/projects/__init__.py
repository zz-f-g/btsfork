...
DATASET_DIR = '/mnt/disk/datasets/'   # where datasets are stored         NOTE: this should be changed!
EXPERIMENT_DIR = '/home/gzz/experiments/'  # where to save the experiments     NOTE: this should be changed!
